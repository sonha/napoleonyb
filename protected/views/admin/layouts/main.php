...
<div class="container" id="page">
    ...
    <div id="header">
        <div id="logo"><?php echo CHtml::encode(Yii::app()->name); ?> <span style="font-size: 13px"><a href="/" target="_blank">Xem Shop</a></span></div>
    </div>
    <!-- header -->
    <div id="mainmenu">
        <?php
        $this->widget('zii.widgets.CMenu', array(
            'items' => array(
                ...
                array('label' => 'Q.lý Chuyên mục', 'url' => array('/category/admin')),
                array('label' => 'Q.lý Sản phẩm', 'url' => array('/product/admin')),
                array('label' => 'Đăng nhập', 'url' => array('/site/login'), 'visible' => Yii::app()->user->isGuest),
                array('label' => 'Q.lý Trang', 'url' => array('/page/index')),
    ...
    <div id="footer">
        Copyright &copy; <?php echo date('Y'); ?> by <a href="http://mitonios.com">Mitonios</a>.<br/>
